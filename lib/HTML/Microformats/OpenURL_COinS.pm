...
HTML::Microformats::OpenURL_COinS - the OpenURL COinS poshformat
...
HTML::Microformats::OpenURL_COinS inherits from HTML::Microformats::BASE. See the
base class definition for a description of property getter/setter methods,
constructors, etc.

=cut

package HTML::Microformats::OpenURL_COinS;
...
HTML::Microformats::OpenURL_COinS supports COinS as described at

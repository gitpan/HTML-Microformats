...
HTML::Microformats::hReviewAggregate - the hReview-aggregate microformat
...
=head1 SYNOPSIS
 ...
 my @reviews = HTML::Microformats::hReviewAggregate->extract_all(
...
HTML::Microformats::hReviewAggregate inherits from HTML::Microformats::BASE. See the
base class definition for a description of property getter/setter methods,
constructors, etc.

=cut

package HTML::Microformats::hReviewAggregate;

use base qw(HTML::Microformats::hReview);
use common::sense;
use 5.008;
...
HTML::Microformats::hReviewAggregate supports hReview-aggregate 0.2 as described at

...
HTML::Microformats::_cache - cache for microformat objects
...
package HTML::Microformats::_cache;
...
=item C<< $cache = HTML::Microformats::_cache->new >>
...
For a given context, package (e.g. 'HTML::Microformats::hCard') and DOM

...
HTML::Microformats::hAudio - the hAudio microformat
...
=head1 SYNOPSIS
 ...
 my @haudios = HTML::Microformats::hAudio->extract_all(
...
HTML::Microformats::hAudio inherits from HTML::Microformats::BASE. See the
base class definition for a description of property getter/setter methods,
constructors, etc.

=cut

package HTML::Microformats::hAudio;
...
HTML::Microformats::hAudio supports hAudio 0.91 as described at

...
HTML::Microformats::hResume inherits from HTML::Microformats::BASE. See the
base class definition for a description of property getter/setter methods,
constructors, etc.

=cut

package HTML::Microformats::hResume;
...
HTML::Microformats::hResume supports hResume as described at
